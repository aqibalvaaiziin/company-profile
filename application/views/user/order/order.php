<img src="https://cdn.shopify.com/s/files/1/0012/2005/1002/files/E_S-Fall-Sale_169405d4-f057-4acf-81ef-d9f248069641.jpg?v=1570740655" alt=""
	style = "position:abbsolute;width:400px;height:300px" id="order"
>
<section class="sec" style="margin-top:-17rem">
	...
	<div class="formContent d-flex justify-content-between">
		<div class="align-self-end boxDecor "></div>
		<div class="align-self-center formBox text-center">
			<h4 class="roboto-head font-weight-bolder" style="color:rgb(163, 69, 119)">Booking</h4>
			<h2 class="futra-head mt-3 font-weight-bolder">Make a Declination </h2>
			<div class="boxFormData d-flex flex-column h-75 justify-content-between mt-5">
				...
				<input type="date" class="futura-content" placeholder="Date For Order">
