					...
					<div class="card rounded-6">
						...
						<div class="card-body">
							<form action="" role="form" autocomplete="off" id="fromLogin" class="form" method="post">
								...
								<a href="<?= base_url().'register' ?>" class="btn btn-primary btn-block">
									<i class="fa fa-registered" aria-hidden="true"></i> &nbsp; Register
								</a>
								<a href="<?= base_url().'user/home' ?>" class="btn btn-info btn-block ">
									<i class="fa fa-chevron-circle-right" aria-hidden="true"></i></i> &nbsp; Go To User Page
								</a>
